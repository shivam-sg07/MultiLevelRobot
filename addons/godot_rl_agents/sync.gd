...
@export var onnx_model_path2 := "/Users/shivamgupta/Downloads/godot_rl_agents_examples-main-2/examples/MultiLevelRobot/020july_initial.onnx"
...
func _initialize():
	...
	match control_mode:
		...
		ControlModes.ONNX_INFERENCE:
				assert(FileAccess.file_exists(onnx_model_path2), "Onnx Model Path set on Sync node does not exist: %s" % onnx_model_path2)
				onnx_model = ONNXModel.new(onnx_model_path2, 1)
				_set_heuristic("model")	
